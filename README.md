...
类似Unity助手，但是该超级智能体属于通用智能体，可以通过一系列提示词，让智能体帮你做事，比如可以网页查询、下载文件等。
...
和图片生成模块类似，能够生成5秒或10秒的视频，提供下载功能。
...
（这部分比较详细，便于复习回顾，并且会特殊标注本人感觉比较重要的特点）

### 后端

1. 基于Spring Boot3.6和MyBatis-Flex搭建后端项目核心架构。
2. 设置全局异常处理增强项目的健壮性，设置全局响应类型增强项目的可读性。
3.
