...
import { BackToBottomButtonProps } from "../../index";
import { ProChatLocale } from "../../locale";
import { ChatMessage } from "../../types";
import { ProChatMetaData, ProChatUserProfile } from '../../hooks/useChatList';
import { ModelConfig } from '../../types/config';
import { ChatListProps } from '../ChatList';
import { ChatInputAreaProps } from '../ProChatInputArea';
...
export interface ProChatInstance<T = Record<string, any>> {
     ...
     * @returns
     */
    genMessageRecord: (message: Partial<ChatMessage<T>>, userType: 'assistant' | 'user') => ChatMessage<T>;
    setInputAreaValue: (value: string) => void;
}
export type ProChatChatReference<T = Record<string, any>> = MutableRefObject<ProChatInstance<T> | undefined>;
/**
 ...
 */
export interface ProChatProps<T extends Record<string, any> = Record<string, any>, Params extends Record<string, any> = Record<string, any>> {
    /**
     * 聊天的参数,没次发起请求都会带入
     */
    params?: Params;
     ...
     */
    sendMessageRequest?: (message: ChatMessage<T>[], params: Params & ModelConfig) => Promise<Response | ChatMessage<T>>;
    /**
 ...
 * 对话组件的属性接口
 */
export declare function ProChat<T extends Record<string, any> = Record<string, any>, Params extends Record<string, any> = Record<string, any>>(props: ProChatProps<T, Params>): import("react/jsx-runtime").JSX.Element;
